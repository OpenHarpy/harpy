...
N = 1000
taskSet.add_maps([
    MapTask(name="map", fun=map_fun, kwargs={"i_start": 1, "i_end": 250, "n": N}),
    MapTask(name="map", fun=map_fun, kwargs={"i_start": 251, "i_end": 500, "n": N}),
    MapTask(name="map", fun=map_fun, kwargs={"i_start": 501, "i_end": 750, "n": N}),
    MapTask(name="map", fun=map_fun, kwargs={"i_start": 751, "i_end": 1000, "n": N})
])
taskSet.add_reduce(
